...
/**
 * Defines the Mangocam API QUIT command.<br>
 * <br>
 * When the client is shutting down / about to turn off, there should be a QUIT command
 * issued to the server if possible to do so to shut down cleanly.<br>
 * <br>
 * Response example:<br>
 * <br>
 * OK {"cmd":"QUIT"}
 */
public class QuitCommand implements MangocamCommand {
    ...
    /**
     * Creates a new QuitCommand object.
     *
     * @param context the context where the object is used
     */
    public QuitCommand(@NotNull Context context) {
        mContext = context;
    }

    @Override
    public String get() throws JSONException {
        return "QUIT {\"reason\":\"shutdown\"}\r\n";
    }
